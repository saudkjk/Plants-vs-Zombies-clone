...
public class Monster extends Actor {
	...
	public Monster(Double startingPosition, Double initHitbox, BufferedImage img, int health, int coolDown, double speed,
			int attackDamage) {
	...
	public void setCollisionStatus(Actor other) {
		if (other instanceof Ninja && this.isCollidingOther(other))
			setColliding(true);
	}
